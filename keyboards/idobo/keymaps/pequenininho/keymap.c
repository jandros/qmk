...
#define MAC_LAYER_COLOR HSV_WHITE
...
[_MAC] = LAYOUT_ortho_5x15(
   _______, _______, _______, _______, _______, _______, IJ_RECN, IJ_OPNF, IJ_OPNC, _______, _______, _______, _______, _______, _______, \
...
[_ADJUST] = LAYOUT_ortho_5x15(
  ...
  _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   _______, _______, _______, MI_OFF,  TG(_MAC), _______, _______, CK_TOGG, _______, \
  _______, _______, _______, _______, _______, _______,  _______, _______, _______,_______, _______, _______,  _______, _______, _______
)
};
